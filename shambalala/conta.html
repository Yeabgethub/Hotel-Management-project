...
if (array_key_exists('email', $_POST)) {
    ...
    $mail->setFrom('samuelkenaw24@gmail.com', 'First Last');
    ...
    $addresses = [
        'sales' => 'kenawsamuel2721@gmail.com',
        'support' => 'kenawsamuel2721@gmail.com',
        'accounts' => 'kenawsamuel2721@gmail.com',
    ];
    ...
    if (array_key_exists('dept', $_POST) && array_key_exists($_POST['dept'], $addresses)) {
        ...
        $mail->addAddress('kenawsamuel2721@gmail.com'); // Replace with your desired email address
    }
